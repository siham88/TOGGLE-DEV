...
our @ISA=qw(Exporter);
our @EXPORT=qw($bwa $picard $samtools $GATK $cutadapt $fastqc $java $toggle $fastxTrimmer $tophat2 $bowtie2Build $bowtieBuild $htseqcount $radseq);

#toggle path
our $toggle="/home/tranchant/TOGGLE";
...
#path for radseq
our $radseq = "/usr/local/stacks-1.29/bin/process_radtags";
